...
if __name__ == "__main__":
    ...
    fig, ax = plt.subplots()
    fig, ax, line = plot_dispersion_1d(result, branch=0, ax=ax)
    line.set_label("Branch 0")
    fig, ax, line = plot_dispersion_1d(result, branch=1, ax=ax)
    line.set_label("Branch 1")
    fig, ax, line = plot_dispersion_1d(result, branch=2, ax=ax)
